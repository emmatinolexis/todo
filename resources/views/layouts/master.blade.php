                ...
                <div class="container-fluid">
                    ...
                    <div class="modal fade" id="exampleModalgrid" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalgridLabel">Add New Item</h5>
                                ...
                                <div class="modal-body">
                                    <form action="javascript:void(0);">
                                        <div class="row g-3">
                                            ...
                                            <!--end col-->
                                            <div class="col-lg-12">
                                                <label for="genderInput" class="form-label">Description</label>
                                                <textarea class="form-control"></textarea>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-12">
                                                <div>
                                                    <label for="emailInput" class="form-label">Product Images</label>
                    ...
                    <div class="modal modal-lg fade" id="showModal" tabindex="-1" aria-labelledby="showModal"
                        aria-modal="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalgridLabel">Product Details</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-xxl-12">
                                                <div>
                                                    <img src="assets/images/shoe1.png"
                                                        style="border-radius: 20px; margin-left:90px" width="70%"
                                                        height="70%" alt="" class="img-fluid p-1">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-xxl-12">
                                                <div>
                                                    ...
                                                    <hr>
                                                    <p>Leather shoe for last year trend vintage camping season</p>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-xxl-12">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. In,
                                                    consectetur debitis repellat non deserunt soluta, voluptatum dolorum
                                                    ab ex error quidem ea eaque odio similique incidunt temporibus!
                                                    Quae, perspiciatis
                                                    nostrum.
                                                </p>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <h4 class="mb-1 fs-14"><a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#showModal" class="text-dark">Leather Shoe</a>
                                                </h4>
                                                <p class="text-muted text-truncate-two-lines">Leather shoe for last
                                                    year trend vintage camping season</p>
                                            </div>
                                        </div>
                                        <div class="mt-auto">
                                            <img src="assets/images/shoe1.png" alt="" class="img-fluid p-1">
                                        </div>
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mt-auto">
                                            <img src="assets/images/shoe2.png" alt="" class="img-fluid p-1">
                                        </div>
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mt-auto">
                                            <img src="assets/images/shoe3.png" alt="" class="img-fluid p-1">
                                        </div>
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-soft-warning rounded p-2">
                                                        <img src="assets/images/shoe4.png" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-auto">
                                            <img src="assets/images/shoe4.png" alt="" class="img-fluid p-1">
                                        </div>
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mt-auto">
                                            <img src="assets/images/shoe8.png" alt="" class="img-fluid p-1">
                                        </div>
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-soft-warning rounded p-2">
                                                        <img src="assets/images/shoe6.png" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-auto">
                                            <img src="assets/images/shoe6.png" alt="" class="img-fluid p-1">
                                        </div>
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-soft-warning rounded p-2">
                                                        <img src="assets/images/shoe1.png" data-bs-toggle="modal"
                                                            data-bs-target="#showModal" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                                <h4 class="mb-1 fs-14"><a href="#" class="text-dark">Leather
                                                        Shoe</a>
                                                </h4>
                                                <p class="text-muted text-truncate-two-lines">Leather shoe for last
                                                    year trend vintage camping season</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by DevWorld Tech
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/saas/apps-projects-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2023 10:30:28 GMT -->
